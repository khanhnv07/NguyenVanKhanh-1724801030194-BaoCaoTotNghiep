        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form role="form" method="post" action="{{URL::to('admin/service/edit/'.$item->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="service_name" class="form-control"
                                                value="{{$item->service_name}}" placeholder="Enter Service Name" required>
                                        </div>
                                    
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Service Descript</label>
                                            <textarea name="service_desc" id="summary-ckeditor" class="form-control" cols="30" rows="10">
                                                {{$item->service_desc}}
                                            </textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Service Detail</label>
                                            <textarea name="service_detail" class="form-control" id="detail_ckeditor" cols="30" rows="10">
                                                {{$item->service_detail}}
                                            </textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <img src="{{asset('/img/service_images/'.$item->service_image)}}" width="100%" alt="">
                                            <input type="hidden" name="service_image_old" value="{{$item->service_image}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Service Icon</label>
                                            <input name="service_icon" type="text" class="form-control" value="{{$item->service_icon}}">
                                        </div>
